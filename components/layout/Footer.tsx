      ...
      {!active ? (
        ...
        >
          ...
          <div className="row-start-1 col-start-2 col-span-1 justify-self-end md:col-start-3">
            <ThemePicker>
              {(open) => (
                <Button variant="link" className={btnClasses} onClick={open} aria-label="Change theme">
...
const Links = () => (
  <div className="flex gap-2">
    <SimpleTooltip
      label="GitHub"
      children={
        <Button variant="link" className={btnClasses} asChild aria-label="GitHub's repository">
          <a href="https://github.com/devraulu/takataka" target="_blank" rel="noopener noreferrer">
            <Github />
          </a>
        </Button>
      }
    ...
    <SimpleTooltip label="Contact me">
      <Button variant="link" className={btnClasses} asChild aria-label="Contact me via email">
...
const CraftedBy = () => (
  <div className="copy text-xs md:text-sm text-sub mt-2 text-wrap items-center md:inline-flex md:gap-1">
    <div className="flex flex-nowrap">
      ...
      <a className="link flex flex-nowrap items-center" href="https://rauluis.com" target="_blank" rel="noreferrer">
    ...
    <p className="mt-1 md:mt-0">
      heavily inspired by{" "}
      <a href="https://monkeytype.com/" target="_blank" rel="noopener noreferrer" className="link">
        monkeytype.
      </a>
    </p>
  </div>
