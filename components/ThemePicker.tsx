...
import { savedThemeAtom, themeAtom } from "#root/atoms/ui";
          ...
          return (
            ...
            >
              <div className="flex gap-2 items-center">
                <div className={clsx("font-sans", currentlySaved ? "font-bold" : "font-medium")}>{displayName}</div>
                {currentlySaved && <Check size={16} />}
              </div>
              <div className={name}>
                <div
                  className={clsx("flex border-4 border-b-8 m-0 p-0")}
                  style={{
