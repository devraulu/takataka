...
import StatsInfo from "#root/components/StatsInfo";
...
import ResultsChart from "#root/pages/index/ui/ResultsChart.js";
...
const TitleText = ({ children }: ResultsTextProps) => (
  <div className="font-medium text-center text-sub font-display">{children}</div>
);

const ValueText = ({ children }: ResultsTextProps) => (
  <div className="font-bold text-center font-display text-3xl leading-none text-main">{children}</div>
);
